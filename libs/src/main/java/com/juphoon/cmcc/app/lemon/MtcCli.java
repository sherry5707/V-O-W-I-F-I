 ...
 *
 * @return MtcCommonConstants::ZOK Init heartbeat detect successfully. 
 */
  public static int Mtc_CliInitHeartbeatDetect() {
    return MtcCliJNI.Mtc_CliInitHeartbeatDetect();
  }
