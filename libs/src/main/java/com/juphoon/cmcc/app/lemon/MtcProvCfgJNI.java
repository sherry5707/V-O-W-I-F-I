...
public class MtcProvCfgJNI {
  ...
  public final static native boolean Mtc_ProvCfgGetUseDft();
  public final static native String Mtc_ProvCfgGetFileName();
  public final static native int Mtc_ProvCfgSetUseDft(boolean jarg1);
  public final static native int Mtc_ProvCfgSetFileName(String jarg1);
}
