...
public class MtcGbaJNI {
  ...
  public final static native int Mtc_GbaBootStart(int jarg1, int jarg2);
  public final static native void Mtc_GbaBootStop(int jarg1);
  public final static native int Mtc_GbaAuthEnterSecCtx(int jarg1, String jarg2, String jarg3, String jarg4, String jarg5);
  public final static native int Mtc_GbaAuthSetKsExtNaf(String jarg1);
  public final static native String Mtc_GbaAuthGetKsNaf(String jarg1, int jarg2);
  public final static native String Mtc_GbaAuthGetBtid();
}
