...
public class MtcVerJNI {
  ...
  public final static native String Mtc_GetVersion();
  public final static native String Mtc_GetMmeVersion();
  public final static native int Mtc_GetMmpVersion();
  public final static native String Mtc_GetAvatarVersion();
  public final static native String Mtc_GetMelonVersion();
  public final static native String Mtc_GetLemonVersion();
}
