...
public class MtcProfJNI {
  ...
  public final static native int Mtc_ProfGetUserSize();
  public final static native String Mtc_ProfGetUser(int jarg1);
  public final static native String Mtc_ProfGetCurUser();
  public final static native int Mtc_ProfCreateUser(String jarg1);
  public final static native int Mtc_ProfDeleteUser(String jarg1);
  public final static native boolean Mtc_ProfExistUser(String jarg1);
  public final static native int Mtc_ProfSaveProvision();
  public final static native int Mtc_ProfResetProvision();
  public final static native int Mtc_ProfRestoreProvision(int jarg1);
}
