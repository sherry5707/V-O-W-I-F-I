...
public class MtcAcvDbJNI {
  ...
  public final static native int Mtc_AcvDbSetSrvAddr(String jarg1);
  public final static native String Mtc_AcvDbGetSrvAddr();
  public final static native int Mtc_AcvDbSetSrvPort(int jarg1);
  public final static native int Mtc_AcvDbGetSrvPort();
  public final static native int Mtc_AcvDbSetUrl(String jarg1);
  public final static native String Mtc_AcvDbGetUrl();
}
