...
public class MtcLcsJNI {
  ...
  public final static native int Mtc_LcsActivate(String jarg1, int jarg2, String jarg3, String jarg4, String jarg5, String jarg6);
  public final static native boolean Mtc_LcsHasAudioCodec();
  public final static native int Mtc_LcsGetSpecifiedKeySize(String jarg1, String jarg2);
  public final static native String Mtc_LcsGetSpecifiedKeyVal(String jarg1, String jarg2, int jarg3);
}
