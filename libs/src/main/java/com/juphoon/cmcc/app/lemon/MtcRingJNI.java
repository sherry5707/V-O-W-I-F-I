...
public class MtcRingJNI {
  ...
  public final static native int Mtc_RingPlay(int jarg1, int jarg2);
  public final static native int Mtc_RingPlayNoLoop(int jarg1);
  public final static native int Mtc_RingPlayX(String jarg1, int jarg2);
  public final static native void Mtc_RingStop(int jarg1);
  public final static native boolean Mtc_RingIsPlay();
  public final static native boolean Mtc_RingGetMute();
  public final static native int Mtc_RingSetMute(boolean jarg1);
  public final static native boolean Mtc_RingGetMuteType(int jarg1);
  public final static native int Mtc_RingSetMuteType(int jarg1, boolean jarg2);
  public final static native String Mtc_RingGetName(int jarg1);
  public final static native String Mtc_RingGetDesc(int jarg1);
  public final static native int Mtc_RingGetType(String jarg1);
  public final static native String Mtc_RingGetCtmName(int jarg1);
  public final static native int Mtc_RingSetCtmName(int jarg1, String jarg2);
  public final static native String Mtc_RingGetDir();
  public final static native void Mtc_RingSetDir(String jarg1, int jarg2);
}
