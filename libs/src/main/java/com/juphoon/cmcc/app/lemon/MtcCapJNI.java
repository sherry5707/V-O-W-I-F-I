...
public class MtcCapJNI {
  ...
  public final static native int Mtc_CapQryOpt(String jarg1, Object jarg2, int jarg3);
  public final static native int Mtc_CapQryOneImd(String jarg1, Object jarg2, int jarg3, boolean jarg4);
  public final static native int Mtc_CapQryOne(String jarg1, Object jarg2, int jarg3, boolean jarg4);
  public final static native int Mtc_CapQryLst(int jarg1, Object jarg2, boolean jarg3);
  public final static native int Mtc_CapQryPause();
  public final static native int Mtc_CapQryResume();
}
