...
public class MtcImOmsgJNI {
  ...
  public final static native int Mtc_ImOMsgGetMsgCount(int jarg1);
  public final static native int Mtc_ImOMsgGetMsgTypeByIndex(int jarg1, int jarg2);
  public final static native int Mtc_ImOMsgGetMsgIdByIndex(int jarg1, int jarg2);
  public final static native int Mtc_ImOMsgGetSessIdByIndex(int jarg1, int jarg2);
}
