...
import com.kinstalk.her.voipmode.utils.SystemTool;
import com.kinstalk.her.voipmode.utils.VoipLog;
...
public class Constants {
    ...
    public static String getDeviceId() {
        String deviceId = Settings.System.getString(MainApplication.sApp
    ...
    public static String getLogPath() {
        LOG_PATH = MainApplication.sApp.getCacheDir().getAbsolutePath() + File.separator + "log";
